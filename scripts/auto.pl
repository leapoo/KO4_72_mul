...
while(<fh>){
	...
	if(/module(\s+)seg_part\_(\d+)to(\d+)\_cal/){
		...
		for ($i=0;$i<$width;$i++){
			...
			{
					if($s1_1st_73){
						push @lines, "compressor_3to2	compressor_3to2_s1_2nd_u$i	(.in0(row_7[$i]),	.in1(row_8[$i]),	.in2(row_9[$i]),	.out0(pp_0_row_3[$i]),	.out1(pp_0_row_3[$i+1]));\n";	
					}
					if($s1_1st_32){
						push @lines, "compressor_3to2	compressor_3to2_s1_2nd_u$i	(.in0(row_3[$i]),	.in1(row_4[$i]),	.in2(row_5[$i]),	.out0(pp_0_row_2[$i]),	.out1(pp_0_row_2[$i+1]));\n";	
					}
			}
			else
			{		if($s1_1st_73){
		...
		push @lines, $_;
		$s2_1st_73=1;
		for ($i=0;$i<$width+$width_inc_s1;$i++){
			if($i%3==0)
			{
	...
	if(/Step2 1st 3to2 compressor Auto Generate Code Begin/){
	  ...
	  $s2_1st_32=1;
		for ($i=0;$i<$width+$width_inc_s1;$i++){
			...
			$width_inc_s2=$width_inc_s1+1;	
		next;
	}
		if(/Step2 2nd 3to2 compressor Auto Generate Code Begin/){
		push @lines, $_;
		$s2_2nd_32=1;
		for ($i=0;$i<$width+$width_inc_s1;$i++){
			if($i%2==0)
			{
					if($s2_1st_73){
						push @lines, "compressor_3to2	compressor_3to2_s2_2nd_u$i	(.in0(pp_0_row_7[$i]),	.in1(pp_0_row_8[$i]),	.in2(pp_0_row_9[$i]),	.out0(pp_1_row_3[$i]),	.out1(pp_1_row_3[$i+1]));\n";	
					}
					if($s2_1st_32){
						push @lines, "compressor_3to2	compressor_3to2_s2_2nd_u$i	(.in0(pp_0_row_3[$i]),	.in1(pp_0_row_4[$i]),	.in2(pp_0_row_5[$i]),	.out0(pp_1_row_2[$i]),	.out1(pp_1_row_2[$i+1]));\n";	
					}
			}
			else
			{		if($s2_1st_73){
						push @lines, "compressor_3to2	compressor_3to2_s2_2nd_u$i	(.in0(pp_0_row_7[$i]),	.in1(pp_0_row_8[$i]),	.in2(pp_0_row_9[$i]),	.out0(pp_1_row_4[$i]),	.out1(pp_1_row_4[$i+1]));\n";	
					}
					if($s2_1st_32){
						push @lines, "compressor_3to2	compressor_3to2_s2_2nd_u$i	(.in0(pp_0_row_3[$i]),	.in1(pp_0_row_4[$i]),	.in2(pp_0_row_5[$i]),	.out0(pp_1_row_3[$i]),	.out1(pp_1_row_3[$i+1]));\n";	
					}
			}
		}	
		...
		for ($i=0;$i<$width+$width_inc_s2;$i++){
			if($i%2==0)
			{
		...
		for ($i=0;$i<$width+$width_inc_s3;$i++){
			if($i%2==0)
			{
